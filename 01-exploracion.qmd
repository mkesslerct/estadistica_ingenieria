...
Consideremos un conjunto de mediciones del consumo eléctrico de una vivienda, obtenido de [https://archive.ics.uci.edu/ml/datasets/Individual+household+electric+power+consumption#], el UCI Machine Learning Repository (Lichman, M. (2013). UCI Machine Learning Repository [http://archive.ics.uci.edu/ml]. Irvine, CA: University of California, School of Information and Computer Science.) El conjunto de datos inicial es mucho más grande, se han agregado los valores por hora haciendo promedios, para hacerlo más manejable.
En la @fig-household-boxplots, se aprovechan los diagramas de caja bigotes para comparar la potencia global consumida en la vivienda por hora. En lugar de representar sólo el promedio de la potencia consumida por hora, hemos optado por una visualización más rica con un diagrama caja-bigote por cada hora. 

```{python}
#| label: fig-household-boxplots
#| fig-cap: "Comparamos visualmente los valores de potencia global consumida por cada hora del día usando diagramas de caja bigotes."
...
vivienda['hour'] = vivienda.index.hour
fig, ax = plt.subplots(figsize=(10, 4))
sns.boxplot(data=vivienda, x='hour', y='global_active_power', orient='v')
ax.set_xlabel('Hora')
ax.set_ylabel('Potencia global consumida')
plt.show()

``` 

Comentarios: observamos numerosos datos atípicos, pero las cajas indican claramente el patrón de presencia de la familia durante el día. Se suelen levantar entre las 7 y las 8, no están durante el día y regresan sobre las 19 horas.
