...
![Diagrama de barras, frecuencias absolutas, para el @exm-sangre del grupo sanguíneo](figures/barras.pdf){#fig-sangre}
...
![Diagrama de sectores para el ejemplo del grupo sanguíneo ](figures/sectores.pdf){#fig-sectores-sangre}
...
x = np.linspace(0.45, 0.52, num=8)
y = np.array([1,2,4,8,8,10,5,8])
fig, ax = plt.subplots()
ax.stem(x, y)
...
::: {#tbl-newcombfrec}
  ...
  :  Tabla de frecuencias, mediciones de Newcomb.
:::
...
::: center
![ Histograma para las mediciones de Newcomb](figures/newcomb.pdf){#fig-newcomb}
:::
...
::: {#fig-histogramas layout-ncol=2}

![Unimodal](figures/unimodal.pdf){width=6cm}

![Asimétrico](figures/asimetrico.pdf){width=6cm}
     
![Cola larga a la derecha](figures/colalargadcha.pdf){width=6cm}

![Bimodal](figures/bimodal.pdf){width=6cm}

Distintas formas de histogramas
:::
...
::: center
![ Componentes del diagrama caja-bigotes](figures/boxplot.pdf){#fig-boxplot}
:::
...
::: center
![ Cuatro ejemplos de conjuntos de datos ](figures/4nubes.jpg){#fig-4nubes}
:::
...
::: center
![ Ejemplo de nube de puntos ](figures/nube.pdf){#fig-nube}
:::
...
punto $(x_3,y_3)$ y la curva es $y_3-f(\theta,x_3)$, por lo tanto la
suma de cuadrados se escribe
$$SC(\theta)=(y_1-f(\theta,x_1))^2+(y_2-f(\theta,x_2))^2+\cdots+(y_n-f(\theta,x_n))^2.$${#eq-sumacuad}

::: center
![ Ajuste de una curva a la nube de puntos.](figures/nubeajuste.pdf){#fig-nubeajuste width="12cm"}
:::

Buscamos el valor $\hat \theta$ de $\theta$ que minimiza la cantidad
$\theta\mapsto\theta$, en muchos casos, es imposible encontrar este
...
por que considerar todas las rectas, sino podemos restringirnos a las
...
El Ministerio de la Vivienda publica los datos de precios del metro
cuadrado de las viviendas en España. En la gráfica siguiente, @fig-viviendacarm, se ha representado la evolución del
precio del metro cuadrado en la Región de Murcia por cuatrimestres entre
1995 y 2006. Aparece una tendencia exponencial, podemos representar
también el logaritmo del precio para ver si la evolución es entonces
lineal. La gráfica correspondiente aparece en la figura @fig-logviviendacarm. Notar que entre 1996 y 2002, la curva
del logaritmo sigue presentando una curvatura, lo que implica que ¡la
subida fue más que exponencial!

::: center
![Evolución del precio en euros del metro cuadrado de la vivienda en la
región de Murcia, datos cuatrimestrales,
1995-2006.](figures/viviendacarm.pdf){#fig-viviendacarm width="12cm"}
:::

::: center
![Evolución del logaritmo del precio en euros del metro cuadrado de la
vivienda en la región de Murcia, datos cuatrimestrales,
1995-2006.](figures/logviviendacarm.pdf){#fig-logviviendacarm width="12cm"}
:::
