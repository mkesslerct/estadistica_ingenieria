...
![Verosimilitud correspondiente al ejemplo de 10 tiradas de una
moneda.](figures/verosimilitud.png){#fig-verosimilitud width="10cm"}
...
-   Dibujo en la densidad del estadístico
    ...
    ![image](figures/constr_ic.png){width="8cm"}
...
:   La hipótesis de que $\sigma$ es conocida no es realista: en general
    ...
    -   Dibujo en la densidad del estadístico $T$ una región central que
        ...
        ![image](figures/constr_ict.png){width="8cm"}
